package ru.zm.personsCrudRest.controllers;
...
import ru.zm.personsCrudRest.dao.PersonDAO;
...
public class PeopleController {
    ...
    public PeopleController(@Qualifier("implPersonDAOInDB") PersonDAO personDAO) {
